...
import { WormAvatarOptions,   backgroundGradients,   bodyGradients,   earColors,  eyeShadeColors,  mouthColors, pupilGradients, tongueColors } from './types/avatar-options.types';
...
const options = {
    ...
    mouthExpression: [Expression.HAPPY, Expression.SAD, Expression.BLANK, Expression.MEH, Expression.WOH],
    showTongueOrTeeth: [TongueOrTeeth.NONE, TongueOrTeeth.TEETH, TongueOrTeeth.TONGUE],
...
class WormAvatar extends React.Component<WormAvatarOptions> {
    ...
    private processProps(isBackgroundGradient: boolean, backgroundStartColor: string | undefined, hashSeed: number, backgroundEndColor: string | undefined, backgroundGradientDegree: GradientDegree | undefined, bodyHeight: BodyHeight | undefined, bodyShape: BodyShape | undefined, bodyColorGradient: boolean, bodyStartColor: string | undefined, bodyEndColor: string | undefined, bodyGradientDegree: GradientDegree | undefined, showEar: boolean | undefined, earColor: string | undefined, eyeCount: EyeCount | undefined, eyePosition: EyePosition | undefined, eyeShadeColor: string | undefined, eyePupilGradient: boolean, eyePupilStartColor: string | undefined, eyePupilEndColor: string | undefined, mouthColor: string | undefined, mouthExpression: Expression | undefined, showTongueOrTeeth: TongueOrTeeth | undefined, tongueColor: string | undefined, toothCount: ToothCount | undefined) {
        if (isBackgroundGradient) {
            if (backgroundStartColor === null || (backgroundStartColor !== null && backgroundStartColor?.trim() === '') || !isValidHex(backgroundStartColor!)) {
            ...
            if (backgroundGradientDegree === null || backgroundGradientDegree === undefined) {
                ...
                backgroundGradientDegree = gradientDegrees(options.backgroundGradientDegree[index]);
            }
            console.log('backgroundGradientDegree :' + backgroundGradientDegree);
        ...
        if (bodyColorGradient) {
            if (bodyStartColor === null || bodyStartColor === undefined || (bodyStartColor !== null && bodyStartColor?.trim() === '') || !isValidHex(bodyStartColor!)) {
            ...
            if (bodyStartColor === null || (bodyStartColor !== null && bodyStartColor?.trim() === '') || !isValidHex(bodyStartColor!)) {
                const index = hashSeed % options.bodyColor.length;
                bodyStartColor = options.bodyColor[index][0];
            }
        }
        ...
        //Ear Color
        if (earColor === null || earColor === undefined || (earColor !== null && earColor?.trim() === '') || !isValidHex(earColor!)) {
        ...
        //Eye Shade
        if (eyeShadeColor === null || eyeShadeColor === undefined || (eyeShadeColor !== null && eyeShadeColor?.trim() === '') || !isValidHex(eyeShadeColor!)) {
        ...
        if (eyePupilGradient) {
            if (eyePupilStartColor === null || eyePupilStartColor === undefined || (eyePupilStartColor !== null && eyePupilStartColor?.trim() === '') || !isValidHex(eyePupilStartColor!)) {
            ...
            if (eyePupilStartColor === null || (eyePupilStartColor !== null && eyePupilStartColor?.trim() === '') || !isValidHex(eyePupilStartColor!)) {
                const index = hashSeed % options.eyePupilColor.length;
        ...
        //Mouth Color
        if (mouthColor === null || mouthColor === undefined || (mouthColor !== null && mouthColor?.trim() === '') || !isValidHex(mouthColor!)) {
        ...
        //Tongue Color
        if (tongueColor === null || tongueColor === undefined || (tongueColor !== null && tongueColor?.trim() === '') || !isValidHex(tongueColor!)) {
        ...
        return { backgroundStartColor, backgroundEndColor, backgroundGradientDegree, bodyHeight, bodyShape, bodyStartColor, bodyEndColor, bodyGradientDegree, showEar, earColor, eyeCount, eyePosition, eyeShadeColor, eyePupilStartColor, eyePupilEndColor, mouthColor, mouthExpression, showTongueOrTeeth, tongueColor, toothCount };
    }
  }
