...
var Body = function Body(_ref) {
  ...
  return createElement("div", {
    style: avatarBody
  }, showEar && createElement(Fragment, null, createElement(Ear, {
    ...
    earColor: earColor,
    bodyShape: bodyShape
  })), eyeCount === EyeCount.ONE && createElement(Eye, {
  ...
  }), eyeCount === EyeCount.TWO && createElement(Fragment, null, createElement(Eye, {
    showShadow: addShadows,
    eyeSide: EyeSide.LEFT,
    eyePosition: eyePosition,
    ...
    size: size
  }), showTongueOrTeeth === TongueOrTeeth.NONE ? createElement(Fragment, null) : showTongueOrTeeth === TongueOrTeeth.TONGUE ? createElement(Tongue, {
    tongueColor: tongueColor
  }) : showTongueOrTeeth === TongueOrTeeth.TEETH ? createElement(Fragment, null, toothCount === ToothCount.ONE ? createElement(Tooth, {
    toothCount: toothCount,
    toothSide: ToothSide.LEFT,
    size: size
  }) : createElement(Fragment, null, createElement(Tooth, {
    toothCount: toothCount,
    toothSide: ToothSide.LEFT,
    size: size
  }), createElement(Tooth, {
...
export { BodyHeight, BodyShape, EarSide, Expression, EyeCount, EyePosition, EyeSide, TongueOrTeeth, ToothCount, ToothSide, gradientDegrees, hexColor };
//# sourceMappingURL=worm-avatar-react.esm.js.map
